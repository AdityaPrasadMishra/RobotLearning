...
def getCompiledModel():
    ...
    model.add(Dense(5, kernel_initializer='lecun_uniform', input_dim=63))  #-> works for both cumulated input and frame by frame input
    ...
    #model.add() #linear output so we can have range of real-valued outputs
