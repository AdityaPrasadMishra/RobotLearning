...
if __name__ == "__main__":
    ...
    model = fc_neuralnet.getCompiledModel();
    print(model.summary())
    ...
    dFile1 = np.loadtxt(fname="leftVelocitysensor02.txt",dtype=np.float,delimiter=',')
    dFile1 = np.append(dFile1,np.loadtxt(fname="leftVelocitysensor03.txt",dtype=np.float,delimiter=','))
    dFile1 = np.append(dFile1,np.loadtxt(fname="leftVelocitysensor01.txt",dtype=np.float,delimiter=','))
    ...
    dFile2 = np.loadtxt(fname="rightVelocitysensor02.txt",dtype=np.float,delimiter=',')
    dFile2 = np.append(dFile2,np.loadtxt(fname="rightVelocitysensor03.txt",dtype=np.float,delimiter=','))
    dFile2 = np.append(dFile2,np.loadtxt(fname="rightVelocitysensor01.txt",dtype=np.float,delimiter=','))
